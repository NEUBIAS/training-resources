...
motivation: |
  ...
  **Multichannel imaging** typically involves a **fluorescence microscope** equipped with  multiple filter sets or detectors, each specific to a particular **fluorophore’s emission wavelength** (_Note_: This differs from images acquired with color cameras e.g. histological stains)
