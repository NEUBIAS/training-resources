...
1. [Manual shape measurements](https://neubias.github.io/training-resources/measure_shapes/index.html)
    - TODO: Improve the figure, i.e. add manual ROIs, remove the binary, make the cc image coloured (like in the measure_intensities module)
    - TODO: Add manual IJ GUI shape 2D measurements activity, teach that one can save the ROIs!
...
1. [Manual intensity measurements](https://neubias.github.io/training-resources/measure_intensities/index.html)
    - TODO: Add ROIs for the nuclei in the figure 
    - TODO: Add ImageJ GUI manual ROI 2D intensity measurement activity
    - TODO: Add ImageJ GUI manual 2D ROI intensity measurement in a 3D tissue culture image, either in a single slice or sum projection, in a widefield and in confocal image
