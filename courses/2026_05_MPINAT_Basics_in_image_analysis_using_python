...
## Registration
Please register using the portal https://events.gwdg.de/e/bioimage_python_2026
...
Felix Fritz, MPI-NAT, Goettingen

## Course time schedule


see https://events.gwdg.de/e/bioimage_python_2026



## Prerequisites
* You need a laptop with WiFi
...
Among others we will learn some basics image handling, image segmentation and image filtering. 
