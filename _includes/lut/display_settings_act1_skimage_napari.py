...
viewer.add_image(image, name="image_gray_1", colormap="gray", contrast_limits=[200,255])
viewer.add_image(image, name="image_gray_2", colormap="gray", contrast_limits=[0,100])
viewer.add_image(image, name="image_gray_3", colormap="gray", contrast_limits=[0,255])
