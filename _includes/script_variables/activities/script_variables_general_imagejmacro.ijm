...
number1; // This will create an error as number1 with = is not defined.
...
// Use variables in ImageProcessing function with & operator (the other method is using string concatenation)
radiusMedian = 15
